...
class Windows95Error {
  ...
  get errorMessage() {
    const errorList = [
      ...
      "Defy your fate",
      "Begging for mercy?",
      "Sin carves its name deeper than any scar.",
      "What do you expect? Redemption?",
      "Cursed are the ones who wait for grace",
      "Break the chain, or die in it",
      "Wickedness doesn’t repent—it thrives",
      "What do you bleed for, if not vengeance?",
    ];
